...
const PRISMA_MODELS = [
  { label: "eMember Menus", value: "em_Menus" },
  { label: "eMember Menu Descriptions", value: "Em_MenuDescription" },
  { label: "eMember User Guides", value: "Em_UserGuide" },
  { label: "eMember Tables", value: "Em_Tables" },
  { label: "eMember Columns", value: "Em_Columns" },
  { label: "eMember Scripts", value: "EM_Scripts" },
  { label: "eMember Bugs", value: "EM_Bugs" },
  { label: "eMember Released Tasks", value: "EM_ReleasedTasks" },
  { label: "eMember Test Cases", value: "Em_TestCases" },
  // Add more as needed
];
