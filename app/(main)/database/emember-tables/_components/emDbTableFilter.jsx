...
const EmDbTableFilter = ({ table, rowSelection, resetFilters }) => {
  return (
    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between flex-wrap">
      ...
      <div className="flex flex-col gap-3 w-full md:flex-row md:flex-1 md:items-center">
        {/* Menu Name */}
        <InputFilter
          column={table.getColumn("emTableName")}
          placeholder="Search by em table name"
        />
      </div>
...
export default EmDbTableFilter;
