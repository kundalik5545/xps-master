...
import XpsScriptForm from "./_components/XpsScriptForm";
...
const XpsScripts = () => {
  ...
  useEffect(() => {
    const fetchScriptsData = async () => {
      const res = await getXpsSqlScripts();
      setScripts(res.resData);
    };
    fetchScriptsData();
  }, []);

  const menuId = scripts[0]?.xpsMenuId;
  ...
  return (
    <div className="space-y-4 mt-5">
      <PageHeader
        ...
        pageDesc="Manage your SQL Scripts here. *Note: Don't add script from here."
