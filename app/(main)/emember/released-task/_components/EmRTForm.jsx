...
import { EmRTFormSchema } from "@/lib/Schema/FormSchema";
import { zodResolver } from "@hookform/resolvers/zod";
import { ALargeSmall, Hash, Unlink } from "lucide-react";
import { useForm } from "react-hook-form";

export default function EmRTForm({ onFormSubmit, editingData }) {
  const form = useForm({
    resolver: zodResolver(EmRTFormSchema),
